export enum MessageType {
  ...
  STOPPED_VIDEO_NOTIFICATION = "STOPPED_VIDEO_NOTIFICATION",
  STOPPED_AUDIO_NOTIFICATION = "STOPPED_AUDIO_NOTIFICATION",
  ...
  UPDATE_ROOM_CURRENT_TIME = "UPDATE_ROOM_CURRENT_TIME",
